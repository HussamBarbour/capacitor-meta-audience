...
public class CapacitorMetaAudiencePlugin extends Plugin {
    ...
    public void showBanner(PluginCall call) {
        ...
        String providedAdSize = call.getString("adSize", "BANNER_50"); // Default value is BANNER_50
        ...
        switch (providedAdSize) {
          ...
          case "RECTANGLE_HEIGHT_250":
            ...
            break;
          default:
            adSize = AdSize.BANNER_HEIGHT_50; // Default size
            break;
        }
        getActivity()
            .runOnUiThread(
                () -> {
                    ...
                    adView = new AdView(getContext(), placementId, adSize);
